...
public class CChangePassOTPControl extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            DAOAccount user = new DAOAccount();
            Account userf = user.getAccountByEmail(email);
            ...
            if (userf != null) {
                ...
                Session session = Session.getInstance(props, new javax.mail.Authenticator() {
                    protected PasswordAuthentication getPasswordAuthentication() {
                        return new PasswordAuthentication("thientdhe163943@fpt.edu.vn", "apdw paaw taoz eslz ");// Put your email and password
                    }
                });
