                    ...
                    <div class="row mt-5 ">
                        <div class="col-md-6">
                            <ul class="d-flex flex-wrap align-items-center">
                                ...
                                <li class="px-4 py-2 rounded-xl border fs-4 me-3 display-order ${statusSearch.equals('cancel')?"choose":""}">
                                    <a href="OrderManager?Service=searchByStatus&status=cancel"  class="text-black-weak text-decoration-none">
                                        Cancel
                                    </a>
                                </li>
                            </ul>
